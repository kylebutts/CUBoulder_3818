...
$$X \sim N({\color{coral}\mu}, {\color{kelly}\sigma^2})$$
 
- This notation tells us everything we need to know about the normal distribution
      
- The distribution has mean ${\color{coral}\mu}$
- The distribution has variance ${\color{kelly}\sigma^2}$
...
If a variable X follows a normal distribution with ${\color{coral}\mu} = 0$ and  ${\color{kelly}\sigma^2} = 1$, we say that X follows the .hi.purple[standard normal distribution]
...
$$Z= \frac{X-{\color{coral}\mu}}{{\color{kelly}\sigma}} \sim N(0,1)$$
