...
# P(X = 1)
dbinom(x = 1, size = 5, prob = 0.52)

# P(X = 3)
dbinom(x = 3, size = 5, prob = 0.52)

# P(X >= 4) = P(X = 4) + P(X = 5)
dbinom(x = 4, size = 5, prob = 0.52) + dbinom(x= 5, size = 5, prob = 0.52)
...
# P(X = 1) = P(X <= 1) - P(X <= 0)
pbinom(q = 1, size = 5, prob = 0.52) - pbinom(q = 0, size = 5, prob = 0.52)

# P(X = 3) = P(X <= 3) - P(X <= 2)
pbinom(q = 3, size = 5, prob = 0.52) - pbinom(q = 2, size = 5, prob = 0.52)

# P(X >= 4) = P(X <= 5) - P(X <= 3)
pbinom(q = 5, size = 5, prob = 0.52) - pbinom(q = 3, size = 5, prob = 0.52)

# P(X >= 4) = 1 - P(X <= 3)
1 - pbinom(q = 3, size = 5, prob = 0.52)
```
...
```{r}
sample <- rbinom(n = 10, size = 5, prob = 0.52)
...
```{r}
large_sample <- rbinom(n = 10000, size = 5, prob = 0.52)
...
```{r}
# help("Normal")
norm_sample <- rnorm(n = 10000, mean = 91, sd = 3) 
...
```{r}
# P(X <= 91)
pnorm(91, mean = 91, sd = 3)

# P(X > 93)
1 - pnorm(93, mean = 91, sd = 3)

# P(90 < X < 92)$
pnorm(92, mean = 91, sd = 3) - pnorm(90, mean = 91, sd = 3)
```
...
```{r}
# 20th Percentile
qnorm(0.2, mean = 91, sd = 3)

# 60th Percentile
qnorm(0.6, mean = 91, sd = 3)

# 95th Percentile
qnorm(0.95, mean = 91, sd = 3)
```
...
```{r}
percentile <- qnorm(0.95, mean = 91, sd = 3)
pnorm(percentile, mean = 91, sd = 3)
```
